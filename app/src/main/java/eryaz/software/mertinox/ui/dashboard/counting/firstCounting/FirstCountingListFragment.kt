...
import eryaz.software.mertinox.databinding.FragmentFirstCountingListBinding
...
class FirstCountingListFragment : BaseFragment() {
    ...
    private val adapter by lazy {
        eryaz.software.mertinox.ui.dashboard.counting.adapter.CountingListAdapter().also {
