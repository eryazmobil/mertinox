...
import eryaz.software.mertinox.databinding.FragmentInfoFirstCountingBinding
...
class InfoFirstCountingFragment : BaseFragment() {
    ...
    private val productEdtAdapter by lazy(LazyThreadSafetyMode.NONE) {
        eryaz.software.mertinox.ui.dashboard.counting.adapter.InfoProductEdtAdapter().also {
